  ...
  return (
    <section className="form-section">
      <section className="laucher-page">
        ...
        <p><span>Id:</span> {laucherData.id}</p>
        <p><span>City:</span> {laucherData.city}</p>
        <p><span>rocketType:</span> {laucherData.rocketType}</p>
        <p><span>latitude:</span> {laucherData.latitude}</p>
        <p><span>longitude:</span> {laucherData.longitude}</p>
